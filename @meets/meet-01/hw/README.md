...
Създейте ново, Github репозитори, **use-case-1-snowflake**. В него създайте единствена папка sql, в която да качите вашата версия на кода. Запишете кратко видео, в което показвате изпълнението на процеса от началото до края. 